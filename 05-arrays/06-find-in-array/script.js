...
(function() {
    ...
    document.getElementById("run").addEventListener("click", () => people.forEach( (person, index) => {
        if (person.firstname == "Jean" && person.lastname == "Dupont") {
            console.log(`Jean Dupont's email adress is ${person.email}. His index in the array is ${index}`)
        }
    }))
})();
